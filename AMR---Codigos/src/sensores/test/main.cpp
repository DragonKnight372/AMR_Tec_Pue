/*
=========================================================
 SANDBOX TEST — SENSORES
 Copia del firmware oficial. Experimentar AQUÍ.
 Si falla, flashear sensores_can.
 No editar src/sensores/can ni src/sensores/serial.
=========================================================
*/
...
void setup() {
  ...
  Serial.println("{\"status\":\"SENSORES TEST\",\"fw\":\"test\"}");
}
