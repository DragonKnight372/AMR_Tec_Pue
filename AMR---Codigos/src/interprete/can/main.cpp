/*
 * ================================================================
 * AMR1 - CONTROL MASTER DASHBOARD PRO v2.9
 ...
 *         USB: MODE SERIAL | MODE RC | MODE AUTO | MODE RADIO
...
void splashOLED() {
  ...
  display.setTextSize(1);
  display.setCursor(16, 34); display.print(F("Dashboard PRO v2.9"));
...
void setup() {
  ...
  Serial.println(F("AMR1 interprete_can v2.9"));
