/*
 * ================================================================
 *   SANDBOX TEST — DIRECCIÓN  (copia de v2.5.2, RAW oficiales 1270/2022/2630)
 *   Experimentar AQUÍ. Si falla, flashear direccion_can.
 *   No editar src/direccion/can ni src/direccion/serial.
 * ================================================================
...
// ── Calibración ──────────────────────────────────────────────── version 2.5.3
int rawLeft  = 1270;   // posición IZQUIERDA  (~1198-1201) new 1270   anterior 1242
int rawMid   = 2022;   // posición MEDIA      (~2004-2008) new 2022   anterior 2005
int rawRight = 2630;   // posición DERECHA    (~2738-2743) new 2630   anterior 2865
...
void setup() {
  ...
  if (display.begin(SSD1306_SWITCHCAPVCC, SCREEN_ADDRESS)) {
    ...
    display.setTextColor(SSD1306_WHITE);
    display.setTextSize(1);
    display.setCursor(10, 10); display.print(F("DIRECCION TEST"));
