/*
 * ================================================================
 *   SANDBOX TEST — TREN MOTRIZ  (copia de v2.5)
 *   Experimentar AQUÍ. Si falla, flashear tren_motriz_can.
 *   No editar src/tren_motriz/can ni src/tren_motriz/serial.
 * ================================================================
...
void setup() {
  ...
  if (display.begin(SSD1306_SWITCHCAPVCC, SCREEN_ADDRESS)) {
    ...
    display.setTextSize(1);
    display.setCursor(10, 20);
    display.print(F("TREN MOTRIZ TEST"));
